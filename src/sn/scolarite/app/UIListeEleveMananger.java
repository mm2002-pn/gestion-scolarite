...
import sn.gestionscolarite.datasource.ListeEleveDaoImp;
...
public class UIListeEleveMananger extends JFrame {
	...
	private ListeDao<Eleve> listEleves;
	private EleveModel eleveModel;
	private Dao<Classes> listClasses;
	private JComboBox selectedOption_1;
	private String classeName;

	public UIListeEleveMananger(String classeName) {
	...
	private void createInstanceComponents() throws BadFormatException {
		...
		listEleves = new ListeEleveDaoImp();	
		
		eleveModel.setEleves(listEleves.getList(classeName));
	...
	private void oneSelectedClasse(String classeParm) {
		try {	
			eleveModel.setEleves(listEleves.getList(classeParm));
		} catch (BadFormatException e) {
			e.printStackTrace();
		}
	}
